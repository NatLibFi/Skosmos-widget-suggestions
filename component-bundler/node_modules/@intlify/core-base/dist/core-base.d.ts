...
export declare function compile<Message = string, MessageSource extends string | ResourceNode = string>(message: MessageSource, options?: CoreBaseCompileOptions): MessageFunction<Message>;
export { CompileError }
export { CompileErrorCodes }

export declare function compileToFunction<Message = string, MessageSource extends string | ResourceNode = string>(message: MessageSource, options?: CoreBaseCompileOptions): MessageFunction<Message>;
...
export declare const CoreErrorCodes: {
    ...
    readonly NOT_SUPPORT_AST: number;
...
export declare type MessageCompiler<Message = string, MessageSource extends string | ResourceNode = string> = (message: MessageSource, options?: CompileOptions) => MessageFunction<Message>;
